...
<jsp:useBean id="db" class="cesh.DBean"  scope ="page"/>
	...
	<table>
					...
					<tr>
						...
						<td  rowspan="2" style="text-align:center;"><p><%=hh.getString(9) %></p></td>
						<td style="text-align:center;">*电话</td>
						<td style="text-align:center;">固定<br><p><%=hh.getString(10) %></p></td>
						<td style="text-align:center;">*手机<br><p><%=hh.getString(11) %></p></td>
					</tr>
					<tr>
						<td style="text-align:center;">传真</td>
						<td colspan="2" style="text-align:center;"><p><%=hh.getString(12) %></p></td>
					</tr>
...
<br>
	 <form name="form2" action="judgebmsh.jsp" method="post" onsubmit="return opendialog2()">
    <input type="hidden"  name="infoname" value=<%=infoname %>>
    <input type="hidden"  name="result" value="部门审核未通过">
    <input type="hidden"  name="bm" value="">
	<input type="submit" name="submit" value="不通过" >
	</form>
    <input type="button" onclick="window.location.href='judgebmsh.jsp?infoname=<%=infoname %>&result=部门审核已通过'" name="submit1" value="通  过" >
    <%-- <input type="button" onclick="window.location.href='judgebmsh.jsp?infoname=<%=infoname %>&result=部门审核未通过'" name="submit1" value="不通过" > --%>
