  ...
  <tr>
	...
	<jsp:useBean id="db" class="cesh.DBean" scope ="page"/>
  	<%
			...
			String h = "select * from infotable where institutionName in ( select CName from usertable where usermame='"+name+"')";
			...
			while (hh.next()) {
				...
				out.println("<tr><td>" 
					...
					+ hh.getString(33)
					+ "</td><td><a href='xgaddinfo.jsp?infoname=" + infoname 
					+ "'>修改  </a>"
					+ "<a href='sc.jsp?infoname=" + infoname 
					+ "'>删除  </a>"
					+ "<a href='xq.jsp?infoname=" + infoname 
					+ "'>详情</a></td></tr>");
			}
		%>
		</tbody>
