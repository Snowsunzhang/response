...
<br>
    ...
    <input type="button" onclick="window.location.href='judgexq.jsp?infoname=<%=infoname %>'" name="submit1" value="提    交" >
    <input type="button" onclick="window.location.href='mywj.jsp'" name="submit1" value="返    回" >
<br><br><br><br><br>
  </body>
</html>